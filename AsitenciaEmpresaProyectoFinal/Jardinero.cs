...
{
    public partial class Jardinero : MaterialSkin.Controls.MaterialForm
    {
        /// <summary>
        /// Numero del jardinero
        /// </summary>
        ...
        /// <param name="e"></param>
        private void Jardinero_Load(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void NumtrabaJardi_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        /// <summary>
        /// Se encargar de mostrar el registro de jardineros y cerrar el formulario actual
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">Al hacer clic, realiza la verificación</param>
        private void IngresarJardi_Click(object sender, EventArgs e)
        {
            a = 0;
            bool autorizar = false;
            string departamento = "jardineria";

            foreach (var emp in lista)
            {
                if (NumtrabaJardi.Text == emp.N_Empleado && (emp.Departamento.Equals(departamento, StringComparison.OrdinalIgnoreCase)))
                {
                    ...
                    Registro_jardinero regi = new Registro_jardinero();
                    regi.Show();
                ...
                else if (NumtrabaJardi.Text == emp.N_Empleado && emp.Departamento != "jardineria")
                {

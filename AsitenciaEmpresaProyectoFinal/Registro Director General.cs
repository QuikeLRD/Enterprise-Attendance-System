...
{
    public partial class Registro_Director_General : MaterialSkin.Controls.MaterialForm
    {
        /// <summary>
        /// Numero del empleado
        /// </summary>
        ...
        string[] listar;
        int a = 0;
        public Registro_Director_General()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void FechaHoraJefe_Tick(object sender, EventArgs e)
        {
            fechaJefe.Text= DateTime.Now.ToLongDateString();
            horajefe.Text= DateTime.Now.ToLongTimeString();
        }
        /// <summary>
        /// Realiza la verificación de los datos
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AsistenBoss_Click(object sender, EventArgs e)
        {
            ...
            foreach (var emp in lista)
            {
                if ((string)textBox1.Tag == emp.N_Empleado)
                {
                    ...
                    {
                        int descuento = ((segtotal - 36000) / 3600) * 50;
                        label8.Visible = true;
                        label8.Text = (segtotal - 36000) / 3600 + " Horas";
                        label7.Visible = true;
                        label7.ForeColor = Color.Red;
                        label7.Text = "USTED HA LLEGADO TARDE POR:";
                        emp.Sueldo = Convert.ToString(Convert.ToInt32(emp.Sueldo) - descuento);
                        string direcc = @"C:\Users\carjo\Documents\4° semestre\Programación Avanzada\ProyectoFinalAsistencia\AsitenciaEmpresaProyectoFinal\AsitenciaEmpresaProyectoFinal\bin\Debug\net6.0-windows\basededatos.txt";
        ...
        /// <summary>
        /// Permite imprimir un ticket de estacionamiento
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">guarda los datos en un archivo txt</param>
        private void TicketFreeParking_Click(object sender, EventArgs e)
        {
            a = 0;
            bool autorizar = false;
            foreach (var emp in lista)
            {
                if ((string)textBox1.Tag == emp.N_Empleado)
                {
                    emp.Herramientas = TicketFreeParking.Text;
                    n_empleado = emp.N_Empleado;
                    nombre = emp.Nombre;
                    departamento = emp.Departamento;
                    salario = emp.Sueldo;
                    ...
                    emp.Impresion();
                    ErroresJefe.Text = "Ticket Generado";
                    break;

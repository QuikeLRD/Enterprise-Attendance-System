...
{
    public partial class Registro_Contadores : MaterialSkin.Controls.MaterialForm
    {
        /// <summary>
        /// Numero del empleado
        /// </summary>
        ...
        /// <summary>
        /// Herramientas que solicita el empleado
        /// </summary>
        ...
        string[] listar;
        int a = 0;
        public Registro_Contadores()
        {
            InitializeComponent();
            SkinManager.Theme = MaterialSkinManager.Themes.LIGHT;//Cambia el color de fondo del fomulario

            SkinManager.ColorScheme = new ColorScheme(Primary.Brown500, Primary.Brown500, Primary.Brown500, Accent.DeepOrange700, TextShade.WHITE);//Modifica el color de bordes de ventanas del formulario
        }
        ...
        /// <param name="e"></param>
        private void FechaHoraCont_Tick(object sender, EventArgs e)
        {
            fechaCont.Text = DateTime.Now.ToLongDateString();
            HoraCont.Text = DateTime.Now.ToLongTimeString();
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AsistenConta_Click(object sender, EventArgs e)
        {
            ...
            //VALIDACION DE TIEMPO EN FUNCION DEL DEPARTAMENTO 
            a = 0;
            ...
            foreach (var emp in lista)
            {
                if ((string)textBox1.Tag == emp.N_Empleado)
                {
                    ...
                    {
                        int descuento = ((segtotal - 34200) / 3600) * 50;
                        label8.Visible = true;
                        label8.Text = (segtotal - 34200) / 3600 + " Horas";
                        label7.Visible = true;
        ...
        /// <summary>
        /// Permite imprimir un ticket de material  para los contadores
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">guarda los datos en un archivo txt</param>
        private void TicketCont_Click(object sender, EventArgs e)
        {
            a = 0;
            bool autorizar = false;
            foreach (var emp in lista)
            {
                if ((string)textBox1.Tag == emp.N_Empleado)
                {
                    emp.Herramientas = ErroresCont.Text;
                    n_empleado = emp.N_Empleado;
                    nombre = emp.Nombre;
                    departamento = emp.Departamento;
                    salario = emp.Sueldo;
                    ...
                    emp.Impresion();
                    ErroresCont.Text = "Ticket Generado";
                    break;

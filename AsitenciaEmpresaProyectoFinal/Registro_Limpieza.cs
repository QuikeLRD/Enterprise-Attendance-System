...
{
    public partial class Registro_Limpieza : MaterialSkin.Controls.MaterialForm
    {
        /// <summary>
        /// Numero del empleado
        /// </summary>
        ...
        private void Registro_Limpieza_Load(object sender, EventArgs e)
        {
        ...
        /// <param name="e"></param>
        private void FechaHoraLimp_Tick(object sender, EventArgs e)
        {
            fechaLimp.Text = DateTime.Now.ToLongDateString();
            horaLimp.Text = DateTime.Now.ToLongTimeString();
        }
        /// <summary>
        ///  Realiza el registro y validación
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void RegAsisLimp_Click(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// Permite imprimir un ticket para solicitar material de trabajo
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">guarda los datos en un archivo txt</param>
        private void TicketLimp_Click(object sender, EventArgs e)
        {
            a = 0;
            bool autorizar = false;
            ...
            foreach (var emp in lista)
            {
                if ((string)textBox1.Tag == emp.N_Empleado)
                {
                    emp.Herramientas = textBox2.Text;
                    n_empleado = emp.N_Empleado;
                    nombre = emp.Nombre;
                    departamento = emp.Departamento;
                    salario = emp.Sueldo;
